...
*/
export default function ViewMoreButton({ onIncrease }) {
  return (
    <div className="flex flex-col items-center px-[78px] pr-[79px] gap-2.5 w-full h-7 bg-white flex-none order-3 self-stretch flex-grow-0">

...
export default function Signup() {
  const email = "hghg990124@naver.com";
  ...
  <>
    <header className="w-full h-12 bg-white shadow-md rounded-t-2xl fixed top-0 left-0 right-0 flex-none order-none flex-grow-0 z-10 flex items-center">
      <p className="text-[17px] font-medium ml-6">회원가입</p>
    </header>
    ...
    <form className='flex flex-col gap-[30px]'>
      ...
      {/* 회원가입 버튼 */}
      <button 
        className="longButton w-80 h-10 flex-none order-none flex-grow-0 text-center flex items-center justify-center bg-blue-500 text-white rounded-md hover:bg-blue-600 disabled:opacity-50 disabled:bg-gray-400 disabled:cursor-not-allowed mx-auto"        onClick={signUpHandler} 
